...
import { SimpleClientForm } from '@/components/simple-client-form';
...
export default function DashboardArrowFlow() {
  ...
  const steps = [
    {
      ...
      component: <SimpleClientForm onSubmit={setClientData} initialData={clientData || undefined} />
    },
    {
      id: 2,
      title: "Document Upload",
      subtitle: "Upload required citizenship documents",
      icon: FileText,
      completed: uploadedDocs.length > 0,
      component: <SimpleDocumentUpload 
    ...
    },
    {
      ...
      component: <div className="p-8 text-center text-gray-500 bg-gray-50 rounded-lg">
    ...
    },
    {
      ...
      icon: FileCheck,
      completed: false,
      component: <PDFGenerator applicationData={{
                  ...
                  <div 
                    className={`
                      ...
                      ${isActive ? 'bg-blue-600 border-blue-600 text-white' : 
                        isCompleted || isPast ? 'bg-green-600 border-green-600 text-white' : 
                ...
                <CardContent className="p-4">
                  <div className="flex items-center space-x-3">
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                      ...
                      {step.completed ? <CheckCircle2 className="w-5 h-5" /> : <IconComponent className="w-5 h-5" />}
                    </div>
                    <div className="flex-1">
                      <h3 className="font-medium text-sm">{step.title}</h3>
                      <p className="text-xs text-gray-500">
                        {step.completed ? 'Completed' : step.id === currentStep ? 'In Progress' : 'Pending'}
                      </p>
                    </div>
                  </div>
                </CardContent>
